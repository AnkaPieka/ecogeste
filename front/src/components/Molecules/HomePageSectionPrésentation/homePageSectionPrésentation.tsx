    ...
    <div className="container">
      ...
      <div className="container-text">
        <p className="description">
          Join our <span className="highlighted">echo-challenge app</span> and
          participate in group challenges tant promotes substainable actions to
          support the environment. Together, let's accomplish various
          eco-friendly gestures and make a difference for a better world !<br />
        </p>
        <img
          src={logoFeuilleTitleDown}
          alt="logoFeuille"
          className="logoImageDown"
        />
      </div>
